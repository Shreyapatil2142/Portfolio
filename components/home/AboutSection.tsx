...
const AboutSection = () => {
  ...
  return (
    <div className="h-auto pb-[10%] text-white overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] mt-10 sm-mt-0" id={MENULINKS[1].ref}>
      <div className="w-full mx-auto pt-2 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <div data-aos="fade-up" data-aos-duration="1000">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-left">
                <span className="text-transparent bg-clip-text section-heading">About Me</span>
              </h2>
              <p className="mt-2 text-gray-400 max-w-2xl text-left text-base sm:text-lg flex items-center gap-2" data-aos="zoom-in-up" data-aos-duration="800">
                <Sparkles className="w-5 h-5 text-purple-400" />
                Transforming ideas into digital experiences
                <Sparkles className="w-5 h-5 text-purple-400" />
              </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="#projects" className="w-full lg:w-auto">
                <button data-aos="fade-up" data-aos-duration="1000" className="w-full lg:w-auto sm:px-6 py-2 sm:py-3 rounded-lg border border-[#6366f1]/50 text-[#39c4ef] font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center lg:justify-start gap-2 hover:bg-[#a855f7]/10 ">
                  <Code className="w-4 h-4 sm:w-5 sm:h-5" /> View Projects
                </button>
              </a>
            </div>
