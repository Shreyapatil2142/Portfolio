...
const empty = () => toast.error("Please fill the required fields", { id: "error" });
const success = () => toast.success("Message sent successfully", { id: "success" });
...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      tl.kill();
      trigger.kill(); // also clean up the ScrollTrigger
    };
  }, [sectionRef]);
